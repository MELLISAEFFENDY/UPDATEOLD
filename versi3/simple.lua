...
local function loadRemotes()
    local success, err = pcall(function()
        ...
        -- Use FindFirstChild instead of WaitForChild to avoid hanging
        local packagesFolder = Rs:FindFirstChild("Packages")
        if not packagesFolder then
            print("⚠️ Packages folder not found - continuing without remotes")
            return
        end
        
        local indexFolder = packagesFolder:FindFirstChild("_Index")
        if not indexFolder then
            print("⚠️ _Index folder not found - continuing without remotes")
            return
        end
        
        local netPackage = indexFolder:FindFirstChild("sleitnick_net@0.2.0")
        if not netPackage then
            print("⚠️ sleitnick_net package not found - continuing without remotes")
            return
        end
        
        local netFolder = netPackage:FindFirstChild("net")
        if not netFolder then
            print("⚠️ net folder not found - continuing without remotes")
            return
        end
...
print("🔄 Starting remote loading...")
task.spawn(function()
    loadRemotes()
    print("✅ Remote loading completed")
end)

print("✅ Remote loading initiated in background")
...
local function createCompleteGUI()
    ...
    -- Check if player and PlayerGui are available
    if not player then
    ...
    print("✅ Player and PlayerGui verified")
    
    -- Create main ScreenGui
    local ZayrosFISHIT = Instance.new("ScreenGui")
    ZayrosFISHIT.Name = CONFIG.GUI_NAME
    ZayrosFISHIT.Parent = player.PlayerGui  -- Direct access instead of WaitForChild
    ...
    local EVENT = createMenuButton("EVENT", "EVENT")
    ...
    local CustomCoordsFrame = Instance.new("Frame")
    CustomCoordsFrame.Name = "CustomCoordsFrame"
    CustomCoordsFrame.Parent = Teleport
    CustomCoordsFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    CustomCoordsFrame.BorderSizePixel = 0
    CustomCoordsFrame.Position = UDim2.new(0.044, 0, 0.430, 0)
    CustomCoordsFrame.Size = UDim2.new(0.898, 0, 0.150, 0)
    
    local customCoordsCorner = Instance.new("UICorner")
    customCoordsCorner.Parent = CustomCoordsFrame

    local CustomCoordsTitle = Instance.new("TextLabel")
    CustomCoordsTitle.Parent = CustomCoordsFrame
    CustomCoordsTitle.BackgroundTransparency = 1
    CustomCoordsTitle.Position = UDim2.new(0.020, 0, 0.050, 0)
    CustomCoordsTitle.Size = UDim2.new(0.960, 0, 0.300, 0)
    CustomCoordsTitle.Font = Enum.Font.SourceSansBold
    CustomCoordsTitle.Text = "CUSTOM COORDINATES:"
    CustomCoordsTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    CustomCoordsTitle.TextScaled = true
    CustomCoordsTitle.TextXAlignment = Enum.TextXAlignment.Left

    -- X Coordinate Input
    local XInput = Instance.new("TextBox")
    XInput.Name = "XInput"
    XInput.Parent = CustomCoordsFrame
    XInput.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    XInput.BorderSizePixel = 0
    XInput.Position = UDim2.new(0.050, 0, 0.400, 0)
    XInput.Size = UDim2.new(0.250, 0, 0.450, 0)
    ...
    YInput.Name = "YInput"
    YInput.Parent = CustomCoordsFrame
    YInput.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    YInput.BorderSizePixel = 0
    YInput.Position = UDim2.new(0.320, 0, 0.400, 0)
    YInput.Size = UDim2.new(0.250, 0, 0.450, 0)
    ...
    ZInput.Name = "ZInput"
    ZInput.Parent = CustomCoordsFrame
    ZInput.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    ZInput.BorderSizePixel = 0
    ZInput.Position = UDim2.new(0.590, 0, 0.400, 0)
    ZInput.Size = UDim2.new(0.250, 0, 0.450, 0)
    ...
    -- Custom TP Button
    local CustomTPButton = Instance.new("TextButton")
    CustomTPButton.Name = "CustomTPButton"
    CustomTPButton.Parent = CustomCoordsFrame
    CustomTPButton.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
    CustomTPButton.BorderSizePixel = 0
    CustomTPButton.Position = UDim2.new(0.860, 0, 0.400, 0)
    CustomTPButton.Size = UDim2.new(0.120, 0, 0.450, 0)
    CustomTPButton.Font = Enum.Font.SourceSansBold
    CustomTPButton.Text = "TP"
    CustomTPButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    CustomTPButton.TextScaled = true
    
    local customTPCorner = Instance.new("UICorner")
    customTPCorner.Parent = CustomTPButton

    -- Save Current Position Button
    local SavePosButton = Instance.new("TextButton")
    SavePosButton.Name = "SavePosButton"
    SavePosButton.Parent = Teleport
    SavePosButton.BackgroundColor3 = Color3.fromRGB(0, 200, 0)
    SavePosButton.BorderSizePixel = 0
    SavePosButton.Position = UDim2.new(0.044, 0, 0.600, 0)
    SavePosButton.Size = UDim2.new(0.430, 0, 0.070, 0)
    SavePosButton.Font = Enum.Font.SourceSansBold
    SavePosButton.Text = "💾 SAVE CURRENT POSITION"
    SavePosButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    SavePosButton.TextScaled = true
    ...
    ReturnPosButton.Name = "ReturnPosButton"
    ReturnPosButton.Parent = Teleport
    ReturnPosButton.BackgroundColor3 = Color3.fromRGB(100, 100, 255)
    ReturnPosButton.BorderSizePixel = 0
    ReturnPosButton.Position = UDim2.new(0.494, 0, 0.600, 0)
    ReturnPosButton.Size = UDim2.new(0.430, 0, 0.070, 0)
    ReturnPosButton.Font = Enum.Font.SourceSansBold
    ReturnPosButton.Text = "🔙 RETURN TO SAVED"
    ReturnPosButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    ReturnPosButton.TextScaled = true
    
    local returnPosCorner = Instance.new("UICorner")
    returnPosCorner.Parent = ReturnPosButton

    -- Variables for saved position
    local savedPosition = nil

    -- Enhanced teleportation function with safety checks
    local function safeTeleport(targetCFrame, locationName)
        if not player.Character or not player.Character:FindFirstChild("HumanoidRootPart") then
            createNotification("❌ Character not found! Cannot teleport.", Color3.fromRGB(255, 0, 0))
            return
        end
    ...
    -- Custom TP Button Connection
    connections[#connections + 1] = CustomTPButton.MouseButton1Click:Connect(function()
        ...
        if x and y and z then
            safeCall(function()
                safeTeleport(CFrame.new(x, y, z), "Custom Location (" .. x .. ", " .. y .. ", " .. z .. ")")
                XInput.Text = ""
                YInput.Text = ""
                ZInput.Text = ""
            end)
        else
            createNotification("❌ Invalid coordinates! Use numbers only", Color3.fromRGB(255, 0, 0))
        end
    end)

    -- Save Position Button Connection
    connections[#connections + 1] = SavePosButton.MouseButton1Click:Connect(function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            savedPosition = player.Character.HumanoidRootPart.CFrame
            local pos = savedPosition.Position
            createNotification("💾 Position saved! (" .. math.floor(pos.X) .. ", " .. math.floor(pos.Y) .. ", " .. math.floor(pos.Z) .. ")", Color3.fromRGB(0, 200, 0))
        else
            createNotification("❌ Character not found!", Color3.fromRGB(255, 0, 0))
        end
    end)

    -- Return to Saved Position Button Connection
    connections[#connections + 1] = ReturnPosButton.MouseButton1Click:Connect(function()
        if savedPosition then
            safeCall(function()
                safeTeleport(savedPosition, "Saved Position")
            end)
        else
            createNotification("❌ No saved position! Save a position first", Color3.fromRGB(255, 100, 0))
        end
    end)    -- Save Position Button Connection
    connections[#connections + 1] = SavePosButton.MouseButton1Click:Connect(function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            savedPosition = player.Character.HumanoidRootPart.CFrame
            local pos = savedPosition.Position
    ...
    connections[#connections + 1] = ReturnPosButton.MouseButton1Click:Connect(function()
        if savedPosition then
            safeCall(function()
                ...
                createNotification("🔙 Returned to saved position!", Color3.fromRGB(100, 100, 255))
            end)
        else
            createNotification("❌ No saved position! Save a position first", Color3.fromRGB(255, 100, 0))
        end
    ...
    local GetCurrentPosButton = Instance.new("TextButton")
    GetCurrentPosButton.Name = "GetCurrentPosButton"
    GetCurrentPosButton.Parent = Teleport
    GetCurrentPosButton.BackgroundColor3 = Color3.fromRGB(255, 100, 100)
    GetCurrentPosButton.BorderSizePixel = 0
    GetCurrentPosButton.Position = UDim2.new(0.044, 0, 0.690, 0)
    GetCurrentPosButton.Size = UDim2.new(0.898, 0, 0.070, 0)
    GetCurrentPosButton.Font = Enum.Font.SourceSansBold
    GetCurrentPosButton.Text = "📍 GET CURRENT POSITION"
    GetCurrentPosButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    GetCurrentPosButton.TextScaled = true
    
    local getCurrentPosCorner = Instance.new("UICorner")
    getCurrentPosCorner.Parent = GetCurrentPosButton

    -- Current Position Display
    local CurrentPosDisplay = Instance.new("TextLabel")
    CurrentPosDisplay.Name = "CurrentPosDisplay"
    CurrentPosDisplay.Parent = Teleport
    CurrentPosDisplay.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    CurrentPosDisplay.BorderSizePixel = 0
    CurrentPosDisplay.Position = UDim2.new(0.044, 0, 0.780, 0)
    CurrentPosDisplay.Size = UDim2.new(0.898, 0, 0.060, 0)
    CurrentPosDisplay.Font = Enum.Font.SourceSans
    CurrentPosDisplay.Text = "Current Position: Not Available"
    CurrentPosDisplay.TextColor3 = Color3.fromRGB(255, 255, 255)
    CurrentPosDisplay.TextScaled = true
    
    local currentPosCorner = Instance.new("UICorner")
    currentPosCorner.Parent = CurrentPosDisplay

    -- Get Current Position Button Connection
    connections[#connections + 1] = GetCurrentPosButton.MouseButton1Click:Connect(function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            CurrentPosDisplay.Text = "Current Position: X=" .. math.floor(pos.X) .. ", Y=" .. math.floor(pos.Y) .. ", Z=" .. math.floor(pos.Z)
            createNotification("📍 Current position loaded into coordinates", Color3.fromRGB(255, 100, 100))
        else
            createNotification("❌ Character not found!", Color3.fromRGB(255, 0, 0))
        end
    end)

    -- Auto-update current position display
    ...
    --                         EVENT FRAME
    -- ===============================================================
    local EventFrame = Instance.new("ScrollingFrame")
    EventFrame.Name = "EventFrame"
    EventFrame.Parent = FrameUtama
    EventFrame.Active = true
    EventFrame.BackgroundTransparency = 1
    EventFrame.Position = UDim2.new(0.376, 0, 0.147, 0)
    EventFrame.Size = UDim2.new(0.624, 0, 0.853, 0)
    EventFrame.Visible = false
    EventFrame.ZIndex = 2
    EventFrame.ScrollBarThickness = 6
    EventFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y

    local EventListLayoutFrame = Instance.new("Frame")
    EventListLayoutFrame.Name = "EventListLayoutFrame"
    EventListLayoutFrame.Parent = EventFrame
    EventListLayoutFrame.BackgroundTransparency = 1
    EventListLayoutFrame.Position = UDim2.new(0, 0, 0.022, 0)
    EventListLayoutFrame.Size = UDim2.new(1, 0, 0.978, 0)

    local EventListLayout = Instance.new("UIListLayout")
    EventListLayout.Parent = EventListLayoutFrame
    EventListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    EventListLayout.Padding = UDim.new(0, 8)

    -- Event Header
    local EventHeaderFrame = Instance.new("Frame")
    EventHeaderFrame.Name = "EventHeaderFrame"
    EventHeaderFrame.Parent = EventListLayoutFrame
    EventHeaderFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    EventHeaderFrame.BorderSizePixel = 0
    EventHeaderFrame.Size = UDim2.new(0.950, 0, 0, 80)
    EventHeaderFrame.LayoutOrder = 1
    
    local eventHeaderCorner = Instance.new("UICorner")
    eventHeaderCorner.Parent = EventHeaderFrame

    local EventHeaderText = Instance.new("TextLabel")
    EventHeaderText.Parent = EventHeaderFrame
    EventHeaderText.BackgroundTransparency = 1
    EventHeaderText.Position = UDim2.new(0.030, 0, 0.125, 0)
    EventHeaderText.Size = UDim2.new(0.940, 0, 0.750, 0)
    EventHeaderText.Font = Enum.Font.SourceSansBold
    EventHeaderText.Text = "🦈 EVENT LOCATIONS\n\nTeleport to special event locations and fishing spots!"
    EventHeaderText.TextColor3 = Color3.fromRGB(255, 255, 255)
    EventHeaderText.TextScaled = true
    EventHeaderText.TextXAlignment = Enum.TextXAlignment.Left
    EventHeaderText.TextYAlignment = Enum.TextYAlignment.Top
    ...
    -- Manual Player TP Input
    local ManualPlayerInput = Instance.new("TextBox")
    ManualPlayerInput.Name = "ManualPlayerInput"
    ManualPlayerInput.Parent = Teleport
    ManualPlayerInput.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    ManualPlayerInput.BorderSizePixel = 0
    ManualPlayerInput.Position = UDim2.new(0.044, 0, 0.330, 0)
    ManualPlayerInput.Size = UDim2.new(0.450, 0, 0.080, 0)
    ManualPlayerInput.Font = Enum.Font.SourceSans
    ManualPlayerInput.PlaceholderText = "Enter player name..."
    ManualPlayerInput.Text = ""
    ManualPlayerInput.TextColor3 = Color3.fromRGB(255, 255, 255)
    ManualPlayerInput.TextScaled = true
    ManualPlayerInput.TextXAlignment = Enum.TextXAlignment.Left
    
    local manualInputCorner = Instance.new("UICorner")
    manualInputCorner.Parent = ManualPlayerInput

    -- Manual Player TP Button
    local ManualPlayerTPButton = Instance.new("TextButton")
    ManualPlayerTPButton.Name = "ManualPlayerTPButton"
    ManualPlayerTPButton.Parent = Teleport
    ManualPlayerTPButton.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
    ManualPlayerTPButton.BorderSizePixel = 0
    ManualPlayerTPButton.Position = UDim2.new(0.510, 0, 0.330, 0)
    ManualPlayerTPButton.Size = UDim2.new(0.150, 0, 0.080, 0)
    ManualPlayerTPButton.Font = Enum.Font.SourceSansBold
    ManualPlayerTPButton.Text = "TP TO PLAYER"
    ManualPlayerTPButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    ManualPlayerTPButton.TextScaled = true
    
    local manualTPCorner = Instance.new("UICorner")
    manualTPCorner.Parent = ManualPlayerTPButton
    ...
    -- Manual Player TP button connection
    connections[#connections + 1] = ManualPlayerTPButton.MouseButton1Click:Connect(function()
        local targetPlayerName = ManualPlayerInput.Text:trim()
        if targetPlayerName and targetPlayerName ~= "" then
            local targetPlayer = Players:FindFirstChild(targetPlayerName)
            if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                safeCall(function()
                    safeTeleport(targetPlayer.Character.HumanoidRootPart.CFrame, targetPlayerName .. "'s location")
                    ManualPlayerInput.Text = ""
                end)
            else
                createNotification("❌ Player '" .. targetPlayerName .. "' not found!", Color3.fromRGB(255, 0, 0))
            end
        else
            createNotification("❌ Please enter a player name first!", Color3.fromRGB(255, 100, 0))
        end
    end)
    ...
    connections[#connections + 1] = EVENT.MouseButton1Click:Connect(function()
        showPanel("Event")
    end)
    ...
    -- Create island buttons with edit functionality
    safeCall(function()
        local index = 0
        for _, island in ipairs(tpFolder:GetChildren()) do
            if island:IsA("BasePart") then
                ...
                btn.Size = UDim2.new(1, -25, 0.08, 0)  -- Leave space for edit button
                btn.Position = UDim2.new(0, 0, (0.08 + 0.02) * index, 0)
                btn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                editBtn.Name = "Edit_" .. island.Name
                editBtn.Size = UDim2.new(0, 20, 0.08, 0)
                editBtn.Position = UDim2.new(1, -20, (0.08 + 0.02) * index, 0)
                editBtn.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
                editBtn.Text = "📝"
                editBtn.TextScaled = true
                editBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                editBtn.Font = Enum.Font.SourceSansBold
                editBtn.Parent = ListOfTPIsland
                
                -- Island teleport connection
                connections[#connections + 1] = btn.MouseButton1Click:Connect(function()
                    safeCall(function()
                        safeTeleport(island.CFrame, island.Name)
                    end)
                end)
                
                -- Edit coordinates connection
                connections[#connections + 1] = editBtn.MouseButton1Click:Connect(function()
                    local pos = island.CFrame.Position
                    XInput.Text = tostring(math.floor(pos.X))
                    YInput.Text = tostring(math.floor(pos.Y))
                    ZInput.Text = tostring(math.floor(pos.Z))
                    createNotification("📝 " .. island.Name .. " coordinates loaded into custom fields", Color3.fromRGB(255, 165, 0))
                    ListOfTPIsland.Visible = false
                end)
    ...
    -- ===============================================================
    --                      EVENT TELEPORT SETUP
    -- ===============================================================
    
    -- Create event buttons with edit functionality
    safeCall(function()
        local eventOrder = 1
        for eventName, eventCFrame in pairs(EventLocations) do
            -- Main event button
            local eventBtn = Instance.new("TextButton")
            eventBtn.Name = "Event_" .. eventName
            eventBtn.Size = UDim2.new(0.950, 0, 0, 60)
            eventBtn.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
            eventBtn.BorderSizePixel = 0
            eventBtn.Text = eventName
            eventBtn.TextScaled = true
            eventBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
            eventBtn.Font = Enum.Font.SourceSansBold
            eventBtn.Parent = EventListLayoutFrame
            eventBtn.LayoutOrder = eventOrder + 1  -- +1 because header is order 1
            
            local eventBtnCorner = Instance.new("UICorner")
            eventBtnCorner.Parent = eventBtn
            
            -- Event info display
            local eventInfoFrame = Instance.new("Frame")
            eventInfoFrame.Name = "Info_" .. eventName
            eventInfoFrame.Size = UDim2.new(0.950, 0, 0, 50)
            eventInfoFrame.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
            eventInfoFrame.BorderSizePixel = 0
            eventInfoFrame.Parent = EventListLayoutFrame
            eventInfoFrame.LayoutOrder = eventOrder + 1000  -- Show after all buttons
            
            local eventInfoCorner = Instance.new("UICorner")
            eventInfoCorner.Parent = eventInfoFrame
            
            local pos = eventCFrame.Position
            local eventInfoText = Instance.new("TextLabel")
            eventInfoText.Parent = eventInfoFrame
            eventInfoText.BackgroundTransparency = 1
            eventInfoText.Size = UDim2.new(1, 0, 1, 0)
            eventInfoText.Font = Enum.Font.SourceSans
            eventInfoText.Text = string.format("📍 Coordinates: X=%.1f, Y=%.1f, Z=%.1f", pos.X, pos.Y, pos.Z)
            eventInfoText.TextColor3 = Color3.fromRGB(200, 200, 200)
            eventInfoText.TextScaled = true
            eventInfoText.TextXAlignment = Enum.TextXAlignment.Left
            
            local eventInfoPadding = Instance.new("UIPadding")
            eventInfoPadding.PaddingLeft = UDim.new(0, 10)
            eventInfoPadding.PaddingRight = UDim.new(0, 10)
            eventInfoPadding.Parent = eventInfoFrame
            
            -- Event teleport connection
            connections[#connections + 1] = eventBtn.MouseButton1Click:Connect(function()
                safeCall(function()
                    safeTeleport(eventCFrame, eventName)
                end)
            end)
            
            -- Add hover effects
            connections[#connections + 1] = eventBtn.MouseEnter:Connect(function()
                TweenService:Create(eventBtn, TweenInfo.new(0.2), {
                    BackgroundColor3 = Color3.fromRGB(60, 60, 60)
                }):Play()
            end)
            
            connections[#connections + 1] = eventBtn.MouseLeave:Connect(function()
                TweenService:Create(eventBtn, TweenInfo.new(0.2), {
    ...
    local function updatePlayerList()
        safeCall(function()
            ...
            -- Add current players with coordinates info
            local index = 0
            for _, targetPlayer in pairs(Players:GetPlayers()) do
                if targetPlayer ~= player and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    btn.Size = UDim2.new(1, -25, 0.08, 0)  -- Leave space for info button
                    btn.Position = UDim2.new(0, 0, (0.08 + 0.02) * index, 0)
                    btn.TextScaled = true
                    btn.Font = Enum.Font.GothamBold
                    
                    -- Info button to show coordinates
                    local infoBtn = Instance.new("TextButton")
                    infoBtn.Name = "Info_" .. targetPlayer.Name
                    infoBtn.Size = UDim2.new(0, 20, 0.08, 0)
                    infoBtn.Position = UDim2.new(1, -20, (0.08 + 0.02) * index, 0)
                    infoBtn.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
                    infoBtn.Text = "📍"
                    infoBtn.TextScaled = true
                    infoBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                    infoBtn.Font = Enum.Font.SourceSansBold
                    infoBtn.Parent = ListOfTpPlayer
                    
                    -- Player teleport connection
                    connections[#connections + 1] = btn.MouseButton1Click:Connect(function()
                        if targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                            safeCall(function()
                                safeTeleport(targetPlayer.Character.HumanoidRootPart.CFrame, targetPlayer.Name .. "'s location")
                            end)
                        else
                            createNotification("❌ " .. targetPlayer.Name .. " not found!", Color3.fromRGB(255, 0, 0))
                        end
                    end)
                    
                    -- Info button connection
                    connections[#connections + 1] = infoBtn.MouseButton1Click:Connect(function()
                        if targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                            local pos = targetPlayer.Character.HumanoidRootPart.Position
                            XInput.Text = tostring(math.floor(pos.X))
                            YInput.Text = tostring(math.floor(pos.Y))
                            ZInput.Text = tostring(math.floor(pos.Z))
                            createNotification("📍 " .. targetPlayer.Name .. "'s coordinates loaded", Color3.fromRGB(0, 162, 255))
                            ListOfTpPlayer.Visible = false
                        end
                    end)
...
local function initialize()
    ...
    local maxInitTime = 10 -- 10 seconds max
    ...
    if tick() - startTime > maxInitTime then
        warn("❌ Initialization timeout - stopping")
        return false
    end
